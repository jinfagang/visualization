...
VisualizeRects::VisualizeRects()
{
  ...
  detection_filter_subscriber_ = new message_filters::Subscriber<cti_msgs::DetectedObjectArray>(private_nh_,
                                                                                                     object_src_topic,
                                                                                             1);
...
VisualizeRects::SyncedDetectionsCallback(
  ...
  const cti_msgs::DetectedObjectArray::ConstPtr &in_objects)
{
  try
  {
...
cv::Mat
VisualizeRects::ObjectsToRects(cv::Mat in_image, const cti_msgs::DetectedObjectArray::ConstPtr &in_objects)
{
...
bool VisualizeRects::IsObjectValid(const cti_msgs::DetectedObject &in_object)
{
  if (!in_object.valid ||
      in_object.width < 0 ||
      in_object.height < 0 ||
